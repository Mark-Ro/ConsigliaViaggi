...
public class CambiaPasswordPage extends AppCompatActivity {
    ...
    private EditText editTextVecchiaPassword,editTextNuovaPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottoneCambiaPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editTextVecchiaPassword.getText().toString().isEmpty() || editTextNuovaPassword.getText().toString().isEmpty())
                    Toast.makeText(CambiaPasswordPage.this, "Riempire i campi!", Toast.LENGTH_SHORT).show();
                else if (editTextVecchiaPassword.getText().toString().length()<8 || editTextNuovaPassword.getText().toString().length()<8)
